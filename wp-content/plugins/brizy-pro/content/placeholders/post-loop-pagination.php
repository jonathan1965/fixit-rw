...
class BrizyPro_Content_Placeholders_PostLoopPagination extends Brizy_Content_Placeholders_Abstract {
	...
	private function getPostCount( $attributes ) {
		...
		if (  isset($attributes['taxonomy'])  && $attributes['taxonomy'] == 'template' && isset($attributes['value'])  && $attributes['value'] == 'main_query' ) {
			global $wp_query;
			...
			if ( isset($attributes['taxonomy']) && isset($attributes['value']) ) {
